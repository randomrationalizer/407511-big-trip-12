...
// Возвращает шаблон контейнера для информации о маршруте
...
// Возвращает шаблон блока стоимости маршрута
...
// Возвращает шаблон списка точек маршрута
...
render(tripDayElement, createEventListTemplate(), `beforeend`);
